...
?>  
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6">
      ...
      <input type="name" name="name" value="<?=$data['name']?>" class="form-control" id="name" placeholder="Nikhil Agrawal">
    </div>
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" value="<?=$data['skype']?>" class="form-control" name="skype" id="skype" placeholder="@Nikhil250">
    </div>
