...
?>  
  ...
  <label>Project Screenshot/Image (Minimum 1080px X 1080px, Maxsize 2mb)</label>
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
    ...
    <div class="form-group col-md-12">
      <label for="email">Project Discription</label>
      <textarea type="text" class="form-control" name="projectlink" class="form-control"  rows="3" id="email" placeholder="About Project discription"></textarea>
      
    </div>
    <div class="form-group col-md-2 ml-auto">
        <input type="submit" name="addtoportfolio" class="btn btn-primary" value="Add To Design">
    </div>
